...
- Timestamp: `2022-05-09 16:27`
- Build ID: `096a9e5f-e53b-485f-8249-2b892ff64dfe`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/096a9e5f-e53b-485f-8249-2b892ff64dfe.git
$ cd 096a9e5f-e53b-485f-8249-2b892ff64dfe
```
